  ...
  <form id="reportForm" method="POST">
    ...
    <div class="row">
      <div class="col-xxl-lg-6 col-xl-lg-6 col-lg-6">
        <label style="padding: 10px; color: black;">From Date</label>
        <input type="date" name="from-date" id="txt-from-date" class="form-control" required>
        <label style="padding: 10px; color: black;">Position</label>
      ...
      <div class="col-xxl-lg-6 col-xl-lg-6 col-lg-6">
        <label style="padding: 10px; color: black;">End Date</label>
        <input type="date" name="end-date" id="txt-end-date" class="form-control" required>
        <label style="padding: 10px; color: black; ">search</label>
        <div class="row">
